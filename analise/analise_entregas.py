...
for nome_do_arquivo in os.listdir(caminho_dados): #Retorna uma lista de nomes de arquivos e pastas dentro do diretório - "." isso significa o diretório atual
...
resultado_monitoramento = os.path.join(caminho_dados,"Resultado_Monitoramento.xlsx")
if resposta == 'Sim':
   df_resultado_relatorio = pd.read_excel(resultado_monitoramento, sheet_name="Pendentes")
